...
const getUserUpdated = async (req, res = response) => {
...
const changeImageProfile = async (req, res = response) => {
...
const deleteStreetAddress = async (req, res = response) => {
...
const getAddressOne = async (req, res = response) => {
...
const getAdminNotificationToken = async (req, res = response) => {
...
const updateDeliveryToClient = async (req, res = response) => {
...
module.exports = {
    updateDeliveryToClient,
    updateNotificationToken,
    getAdminNotificationToken,
    getAddressOne,
    deleteStreetAddress,
    addStreetAddress,
    getAddressesUser,
