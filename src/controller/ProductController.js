...
const getProductsTopHome = async (req, res = response) => {
...
const getImagesProducts = async (req, res = response) => {
...
const searchProductForName = async (req, res = response) => {
...
const searchProductsForCategory = async (req, res = response) => {
...
const listProductsAdmin = async (req, res = response) => {
...
const updateStatusProduct = async (req, res = response) => {
